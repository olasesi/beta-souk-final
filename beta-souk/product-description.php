...
while($row_single = mysqli_fetch_array($query_sel_pro_sec)){
                                    ...
                                    ?>
                                        ...
                                        <div class="ps-product__gallery" data-arrow="true">
                                            <div class="item"><a href=""><img src="images/products/<?php echo $row_single['products_image']; ?>" alt=""></a></div>
                                ...
                                <div class="ps-product__variants" data-item="4" data-md="4" data-sm="4" data-arrow="false">
                                    <div class="item"><img src="images/products/<?php echo $row_single['products_image']; ?>" alt=""></div>
                            ...
                            <div class="ps-product__info">
                                ...
                                <!-- <a class="facebook" href="#"><i class="fa fa-facebook"></i></a> -->
                                     ...
                                     <!-- <a class="twitter" href="#"><i class="fa fa-twitter"></i></a><a class="google" href="#"><i class="fa fa-google-plus"></i></a><a class="linkedin" href="#"><i class="fa fa-linkedin"></i></a><a class="instagram" href="#"><i class="fa fa-instagram"></i></a> -->
                                </div>
                            </div>
                        </div>
                ...
                <div class="ps-page__right">
                    ...
                    <aside class="widget widget_sell-on-site">
                        <p><i class="icon-store"></i> Buy from <?php echo $website_name_with_spaces; ?><a href=""> Buy Now !</a></p>
                    </aside>
